<template>
    <v2container :wid="`root`" style="display:flex;flex-direction:column;align-items:flex-start;align-self:stretch;flex-shrink:0;min-width:50px;min-height:50px;animation-duration:1s;" class="form-user-info-wrapper V2Container">
        <v2-form-input :wid="`1580871567706`" class="form-item-block V2Widget" :style="{'position':'relative','margin-top':'10px','margin-bottom':'10px','margin-left':'10px','margin-right':'10px','align-self':'auto','overflow':'hidden','animation-duration':'1s'}" :labelWitdh="labelWidth" :disabled="isDisabled" :theme="{}" :label="`权限名称`" :placeholder="`请输入权限名称`" :title-mode="`col`" :label-witdh="labelWidth" :input-type="`text`" :rows="2" :show-word-limit="false" :clearable="false" :is-required="true" :auto-complete="false" ref="v2-form-input_1580871567706" :value.sync="name">
        </v2-form-input>
        <v2-form-select :wid="`1580876549784`" class="form-item-block V2Widget" :style="{'position':'relative','margin-top':'10px','margin-bottom':'10px','margin-left':'10px','margin-right':'10px','align-self':'auto','overflow':'hidden','animation-duration':'1s'}" :optionConfig="authorityList" :labelWitdh="labelWidth" :theme="{}" :disabled="false" :data-type="`def`" :option-config="authorityList" :options="[{'active':'true','label':'','value':''}]" :label="`父级权限`" :placeholder="`请选择父级权限`" :label-witdh="labelWidth" :title-mode="`col`" :clearable="false" :filterable="true" :is-required="false" ref="v2-form-select_1580876549784" :value.sync="parentId">
        </v2-form-select>
        <v2-form-input :wid="`1580871619270`" class="form-textarea V2Widget" :style="{'position':'relative','margin-top':'10px','margin-bottom':'10px','margin-left':'10px','margin-right':'10px','align-self':'auto','overflow':'hidden','animation-duration':'1s'}" :labelWitdh="labelWidth" :theme="{}" :disabled="false" :label="`描述`" :placeholder="`请输入描述`" :title-mode="`col`" :label-witdh="labelWidth" :input-type="`textarea`" :rows="5" :maxlength="200" :show-word-limit="true" :clearable="false" :is-required="false" :auto-complete="false" ref="v2-form-input_1580871619270" :value.sync="desc">
        </v2-form-input>
        <div :wid="`1580872309891`" class="diaglog-btn-ctn V2Container" style="position:relative;box-sizing:border-box;align-self:stretch;overflow:hidden;display:flex;flex-direction:row;justify-content:flex-end;align-items:flex-start;min-width:50px;min-height:50px;animation-duration:1s;" ref="v2Container_1580872309891">
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                'CONTENT': {
                    ...
                    'mapping': {"1580871567706":[{"id":1580871567706,"modelValue":"labelWitdh","dataValue":"labelWidth","type":""},{"id":1580871567706,"modelValue":"disabled","dataValue":"isDisabled","type":"boolean"},{"id":1580871567706,"modelValue":"value","dataValue":"name","type":""}],"1580871641330":[{"id":1580871641330,"modelValue":"value","dataValue":"parentId","type":""},{"id":1580871641330,"modelValue":"optionConfig","dataValue":"authorityList","type":""},{"id":1580871641330,"modelValue":"labelWitdh","dataValue":"labelWidth","type":""}],"1580871619270":[{"id":1580871619270,"modelValue":"value","dataValue":"desc","type":""},{"id":1580871619270,"modelValue":"labelWitdh","dataValue":"labelWidth","type":""}],"1580876549784":[{"id":1580876549784,"modelValue":"value","dataValue":"parentId","type":""},{"id":1580876549784,"modelValue":"optionConfig","dataValue":"authorityList","type":""},{"id":1580876549784,"modelValue":"labelWitdh","dataValue":"labelWidth","type":""}]}
                },
                /* 标题宽度 */
                'labelWidth': '100px',
                /* 权限名称 */
        ...
        'methods': {
             ...
             */
            v2_component_btn_1580875777000(vueIns) {
                /**
