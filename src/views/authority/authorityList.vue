<template>
    <v2container :wid="`root`" style="display:flex;align-items:flex-start;align-self:stretch;height:100%;box-sizing:border-box;animation-duration:1s;flex-direction:column;min-width:50px;min-height:50px;" class="V2Container">
        ...
        <v2-component-table :wid="`1578539272258`" class="v2-component-table-1578539272258 V2Widget" :style="{'overflow':'hidden','width':'calc(100% - 20px)','height':'557.00px','animation-duration':'1s','margin-top':'10px','margin-bottom':'10px','margin-left':'10px','margin-right':'10px','flex-shrink':0}" :tableData="authorityTableList" :pageSize="pageSize" :totalCount="authorityTotalCount" :theme="{'tableType':'border','size':''}" :columns="[{'active':true,'prop':'name','label':'权限名称','sortable':true,'openFilter':false,'type':'text','combi':[{'active':'true'}],'tagMap':[{'active':'true','type':'text'}],'iconMap':[{'active':'true'}],'filterMap':[{'active':'true'}]},{'active':true,'prop':'creator','label':'创建用户','sortable':true,'openFilter':false,'type':'text','combi':[{'active':'true'}],'tagMap':[{'active':'true','type':'text'}],'iconMap':[{'active':'true'}],'filterMap':[{'active':'true'}]},{'active':true,'prop':'createTime','label':'创建时间','sortable':true,'openFilter':false,'type':'text','combi':[{'active':'true'}],'tagMap':[{'active':'true','type':'text'}],'iconMap':[{'active':'true'}],'filterMap':[{'active':'true'}]},{'active':true,'prop':'editor','label':'最近修改用户','sortable':true,'openFilter':false,'type':'text','combi':[{'active':'true'}],'tagMap':[{'active':'true','type':'text'}],'iconMap':[{'active':'true'}],'filterMap':[{'active':'true'}]},{'active':true,'prop':'editTime','label':'最近修改时间','sortable':true,'openFilter':false,'type':'text','combi':[{'active':'true'}],'tagMap':[{'active':'true','type':'text'}],'iconMap':[{'active':'true'}],'filterMap':[{'active':'true'}]},{'active':true,'prop':'desp','label':'描述','sortable':false,'openFilter':false,'type':'text','combi':[{'active':'true'}],'tagMap':[{'active':'true','type':'text'}],'iconMap':[{'active':'true'}],'filterMap':[{'active':'true'}]},{'active':true,'type':'text','prop':'id','handleLink':true,'handleLinkCB':'handleLinkCallback','linkTarget':'_blank','openTooltip':false,'handleTooltip':true,'tooltipContent':'提示','tooltipContentCallback':'tooltipContentCallback','useMinWidth':true,'headerAlign':'left','align':'left','sortable':false,'openFilter':false,'combi':[],'tagMap':[],'textMap':[],'iconMap':[],'filterMap':[]}]" :table-data="authorityTableList" :selection="`multi`" :selection-location="`left`" :t-height="`100%`" :t-max-height="`100%`" :open-index="false" :open-page="true" :page-size="pageSize" :open-set-page-callback="true" :set-page-callback="`getPageAuthorityList`" :total-count="authorityTotalCount" :tool-bar="true" :tool-title="`操作列`" :tool-location="`right`" :tool-width="`100px`" :tool-btns="[{'active':true,'btnName':'编辑','type':'text','handler':'editAuthority','rowName':'','toolIcon':'','rowValue':''}]" :expand="false" @_op_table_table:selection-change="v2_component_table_1578928960000" ref="v2-component-table_1578539272258" :value.sync="selectedAuthorityList">
        </v2-component-table>
            ...
            getPageAuthorityList(page, size) {
                ...
                ctx.$axios.post(`${axios.server}/authority/list`,params).then(res=>{
                    if(res.success&&res.status){
                      ...
                      ctx.authorityTotalCount = res.obj&&res.obj.total;
                    }
                }).catch(error=>{
