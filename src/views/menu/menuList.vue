        ...
        data() {
            return {
                'CONTENT': {
                    ...
                    'mapping': {"1578537221490":[{"id":1578537221490,"modelValue":"value","dataValue":"username","type":""}],"1578537355608":[{"id":1578537355608,"modelValue":"value","dataValue":"userStatus","type":""}],"1578537726108":[{"id":1578537726108,"modelValue":"value","dataValue":"createTime","type":""}],"1578539272258":[{"id":1578539272258,"modelValue":"tableData","dataValue":"menuTableList","type":""},{"id":1578539272258,"modelValue":"pageSize","dataValue":"pageSize","type":""},{"id":1578539272258,"modelValue":"totalCount","dataValue":"menuTotalCount","type":""}],"1578838455979":[{"id":1578838455979,"modelValue":"total","dataValue":"menuTotalCount","type":""},{"id":1578838455979,"modelValue":"pageSize","dataValue":"pageSize","type":""},{"id":1578838455979,"modelValue":"currentPage","dataValue":"currentPage","type":""}],"1578539296885":[{"id":1578539296885,"modelValue":"visible","dataValue":"$AUTH(`menu/menuList`,1578539296885)","type":""},{"id":1578539296885,"modelValue":"disabled","dataValue":"isDisabled","type":"boolean"}],"1579152110683":[{"id":1579152110683,"modelValue":"value","dataValue":"userStatus","type":""}],"1579152715570":[{"id":1579152715570,"modelValue":"value","dataValue":"creator","type":""}],"1579153658381":[{"id":1579153658381,"modelValue":"value","dataValue":"userStatus","type":""}],"1580789804791":[{"id":1580789804791,"modelValue":"value","dataValue":"menuTitle","type":""}],"1578539271197":[{"id":1578539271197,"modelValue":"visible","dataValue":"$AUTH(`menu/menuList`,1578539271197)","type":""}]}
                },
                /* 创建时间 */
                'createTime': ``,
                /* 当前页码 */
            ...
            getPageMenuList(page, size) {
                ...
                ctx.$axios.post(`${axios.server}/menu/list`,params).then(res=>{
                    if(res.success&&res.status){
                      ...
                      ctx.menuTotalCount = res.obj&&res.obj.totalElements;
                    }
                }).catch(error=>{
