        ...
        data() {
            return {
                'CONTENT': {
                    ...
                    'mapping': {"1578626611968":[{"id":1578626611968,"modelValue":"tableData","dataValue":"roleTableList","type":""}]}
                },
                /* 角色表格数据 */
                'roleTableList': [],
                /* 选中的角色数据 */
